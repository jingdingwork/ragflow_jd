export default {
  translation: {
    ...
    header: {
      ...
      search: 'Search',
      welcome: 'Welcome to',
      brand: 'CTCI intelligent platform',
      brandTagline:
        'CTCI Engineering · Enterprise intelligent knowledge & QA platform',
      dataset: 'Dataset',
      memories: 'Memory',
      apps: 'Apps',
    },
    ...
    feedback: {
      ...
      module_app: 'Application',
      content: 'Feedback',
      contentPlaceholder:
        'Describe the issue or suggestion. You can paste screenshots directly.',
      priority: 'Priority',
      contentRequired: 'Please enter your feedback',
      submitSuccess: 'Feedback submitted, thanks!',
      submitFailed: 'Submission failed',
      maxImages: 'At most {{count}} images',
    },
    tour: {
...
Example: A 1 KB message with 1024-dim embedding uses ~9 KB. The 5 MB default limit holds ~500 such messages.`,
    ...
    knowledgeList: {
      ...
      retrieval: {
        ...
        emptyHint: 'Try different keywords or widen the knowledge base scope.',
        searching: 'Searching…',
        noKnowledgeBase: 'No searchable knowledge base yet.',
        initial: 'Pick a scope and enter keywords to start searching.',
...
<ul>
  ...
  <li>The auto-keyword feature is dependent on the LLM and consumes a significant number of tokens.</li>
    ...
    chat: {
      ...
      enterFailed: 'Failed to enter chat.',
      retry: 'Retry',
      noKnowledgeBound: 'No knowledge base',
      knowledgeCount: '{{count}} knowledge bases',
      selectKnowledgeBases: 'Select knowledge bases',
      noKnowledgeBase: 'No searchable knowledge base.',
      kbGroupCompany: 'Company',
      kbGroupDept: 'Department',
      kbGroupPersonal: 'Personal',
      noAgent: 'No agent',
      ...
      share: 'Share',
      shareZone: 'Share zone',
      shareZoneEmpty: 'No shared conversations from your department yet',
      shareSelectRecords: 'Select chat records to share',
      shareNoRecords: 'This conversation has no shareable records yet',
      shareSuccess: 'Shared successfully',
      pendingReview: 'Pending review',
      hidden: 'Hidden',
      syncToAll: 'Sync to everyone',
      syncedToAll: 'Shared with the whole department',
      hide: 'Hide',
      unhide: 'Unhide',
      continueFromShare: 'Click to preview, then copy and continue chatting',
      ...
      saveValidationFailed: 'Please complete the required fields before saving',
      promptTemplate: 'Prompt',
      promptTemplatePlaceholder: 'Select a prompt',
      applyPromptTemplate: 'Apply a saved prompt',
      savePrompt: 'Save as my prompt',
      savePromptTitle: 'Save prompt',
      promptName: 'Prompt name',
      promptNamePlaceholder: 'Name this prompt so you can reuse it later',
      deletePromptTitle: 'Delete this prompt',
      systemRequiredToSave: 'The system prompt is empty and cannot be saved',
...
[Insert text here]`,
    ...
    admin: {
      ...
      searchMemberPlaceholder: 'Search by nickname / employee ID / email',
      searchMemberNoResult: 'No matching employee found',
      ...
      modelTypeImage2text: 'VLM',
      modelTypeSpeech2text: 'ASR',
      modelTypeRerank: 'Rerank',
      modelTypeTts: 'TTS',
      otherModelSettings: 'Other model settings',
      ...
      modelCustomTagsPlaceholder: 'Type a tag and press Enter',
      modelCatalogDeleteTitle: 'Delete model',
      modelCatalogDeleteConfirm: 'Remove “{{name}}” from the model catalog?',
      globalLlmConfig: 'Global model settings',
      globalLlmDescription:
        'Set one global model per type (Embedding, VLM, ASR, Rerank, TTS) from a single provider. It applies to every user as their default for that type.',
      globalLlmSelectPlaceholder: 'Select a model (optional)',
      save: 'Save',
      saveSuccess: 'Saved successfully',
      ...
      promptPageHint:
        'Manage the default and per-department prompts used when users create a chat. Department users pick one when creating a chat; the default applies when none is set.',
      ...
      promptDepartmentRequired: 'Please select a department',
      promptIsDefault: 'Set as default',
      promptIsDefaultHint:
        'Preselected within its scope. Setting this unsets other defaults in the same scope.',
      promptSystem: 'System prompt',
      promptSystemPlaceholder: 'Enter the system prompt…',
      promptPrologue: 'Opener',
      promptProloguePlaceholder:
        'The assistant greeting shown on entering a chat…',
      promptSort: 'Sort',
      ...
      fbAll: 'All',
      fbStatusOpen: 'Open',
      fbStatusInProgress: 'In progress',
      fbStatusDone: 'Done',
      fbAllModules: 'All modules',
      fbAllPriorities: 'All priorities',
      fbSearchPlaceholder: 'Search feedback content',
      fbColTime: 'Time',
      fbColSubmitter: 'Submitter',
      fbColDept: 'Department',
      fbColModules: 'Modules',
      fbColPriority: 'Priority',
      fbColContent: 'Content',
      fbColStatus: 'Status',
      fbTotal: '{{count}} items',
      fbStat_total: 'Total',
      fbStat_open: 'Open',
      fbStat_in_progress: 'In progress',
      fbStat_done: 'Done',
      fbDetailTitle: 'Feedback detail',
      fbStatus: 'Status',
      fbNote: 'Handling note',
      fbNotePlaceholder: 'Optional handling note',
      fbUpdated: 'Updated',
      ...
      newDeptFolder: 'New folder binding',
      editDeptFolder: 'Edit folder binding',
      deptFolderName: 'Name',
      deptFolderNamePlaceholder: 'Defaults to the folder path if left blank',
      deptFolderDepartment: 'Department',
      deptFolderDepartmentPlaceholder: 'Select a department',
      deptFolderKb: 'Knowledge base',
      deptFolderKbPlaceholder: 'Select the target knowledge base',
      deptFolderKbRequired: 'Please select a knowledge base',
      deptFolderPath: 'Folder path',
      deptFolderPathRequired: 'Please enter the folder path',
      deptFolderPathHint:
        'The path mounted inside the server/container, e.g. /mnt/dept-a. Mount the shared drive on the host first.',
      deptFolderTest: 'Test',
      deptFolderAccessible: 'Folder is accessible',
      deptFolderTestOk: 'Accessible — {{count}} supported files found',
      deptFolderTestFail:
        'Cannot access this folder. Check the mount and permissions.',
      deptFolderExcludeDirs: 'Excluded directories',
      deptFolderExcludeDirsHint:
        'Comma-separated directory names to skip. Recycle bins like #recycle are excluded by default.',
      deptFolderRefreshFreq: 'Refresh interval (minutes)',
      deptFolderRefreshFreqHint:
        'Interval between automatic syncs. The nightly full check runs regardless.',
      deptFolderRecursive: 'Include subfolders',
      deptFolderRecursiveHint: 'Recursively sync files in all subdirectories.',
      deptFolderSyncDeleted: 'Sync deletions',
      deptFolderSyncDeletedHint:
        'Remove documents from the knowledge base when they are deleted from the folder, keeping counts in sync.',
      deptFolderAllowImages: 'Include images',
      deptFolderAllowImagesHint: 'Also sync image files (jpg, png, etc.).',
      deptFolderSync: 'Sync',
      deptFolderRebuild: 'Rebuild',
      deptFolderSyncQueued: 'Incremental sync queued',
      deptFolderRebuildQueued: 'Full rebuild queued',
      deptFolderSyncState: 'Sync status',
      deptFolderNeverSynced: 'Not synced',
      deptFolderDocCount: '{{count}} documents',
      syncStatusUnstart: 'Not started',
      syncStatusRunning: 'Syncing',
      syncStatusCancel: 'Cancelled',
      syncStatusDone: 'Synced',
      syncStatusFail: 'Failed',
      syncStatusSchedule: 'Queued',
      kbReadOnly: 'Read-only',
      kbListTitle: 'All knowledge bases',
      kbGroupBy: 'Group by',
      kbGroupByDept: 'By department',
      kbGroupByOwner: 'By owner',
      kbSearchPlaceholder: 'Search knowledge base name…',
      kbUnassignedDept: 'Unassigned department',
      kbUnknownOwner: 'Unknown owner',
      kbColOwner: 'Owner',
      kbColDept: 'Department',
      kbColDocs: 'Documents',
      kbColChunks: 'Chunks',
      kbColPermission: 'Visibility',
      kbPermMe: 'Private',
      kbPermTeam: 'Team',
      ...
      rtParams: 'Parameters',
      rtResetParams: 'Reset',
      rtVectorWeight: 'Vector weight',
      rtVectorWeightHint:
        'Weight of vector vs. keyword score (0 = keyword only, 1 = vector only).',
      rtThreshold: 'Similarity threshold',
      rtThresholdHint:
        'Drop chunks below this final score. 0 shows the full ordering.',
      rtTopK: 'Top K',
      rtTopKHint: 'Max candidates pulled from the index before ranking.',
