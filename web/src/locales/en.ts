export default {
  translation: {
    ...
    applications: {
      ...
      noPackage: 'No installation package available',
      downloadFailed: 'Download failed',
      back: 'Back',
      openNewTab: 'Open in new tab',
      embedBlocked:
        'This application cannot be embedded here. Open it in a new tab instead.',
    },
    skills: {
      title: 'Skills',
...
Example: Virtual Hosted Style`,
    ...
    fileManager: {
      shareToDepartment: 'Share to department',
      unshareFromDepartment: 'Unshare from department',
...
[Insert text here]`,
    ...
    admin: {
      ...
      syncDepartmentsResult:
        'Sync complete: {{created}} created, {{updated}} updated ({{total}} users in Keycloak)',
      departmentLlmConfig: 'Model config',
      departmentLlmConfigured: 'Model config (configured)',
      userLlmConfig: 'User model config',
      userLlmNoDeptToken:
        'This department has no model token configured yet. Configure the department first to enable models for this user.',
      noModelsAvailable: 'No models available',
      models: 'Models',
      editModels: 'Edit models',
      syncModels: 'Sync models',
      syncModelsResult:
        'Models synced: {{added}} added, {{removed}} removed across {{departments}} departments',
      deptAdmin: 'Dept admin',
      makeDeptAdmin: 'Make dept admin',
      ...
      impersonateOpened: 'Opened a session as {{name}} in a new tab',
      modelApiKey: 'API key',
      fetchModels: 'Fetch models',
      fetchModelsResult: 'Fetched {{count}} models',
      modelsEnabledCount: '{{enabled}} / {{total}} enabled',
      noModelsFetched: 'No models yet — fill in the URL/key and fetch',
      save: 'Save',
      saveSuccess: 'Saved successfully',

      chatHistory: 'Chat history',
      todaySessions: 'Sessions today',
      todayRounds: 'Calls today',
      weekSessions: 'Sessions this week',
      weekRounds: 'Calls this week',
      statRange: 'Range',
      rangeToday: 'Today',
      rangeWeek: 'This week',
      rangeAll: 'All',
      ...
      exportType: 'Type',
      exportTypeDept: 'Department total',
      exportTypeMember: 'Member',
      exportName: 'Name',
      noChatData: 'No chat activity in this range',
      departmentMember: 'Department / member',
      sessionsColumn: 'Sessions',
      roundsColumn: 'Calls',
      chatHistoryDetailTitle: 'Chat history',
      chatSessionsCount: '{{count}} sessions',
      noConversations: 'No conversations in this range',
      selectConversation: 'Select a conversation to view it',
      noMessages: 'No messages',
      sourceChat: 'Chat',
      sourceAgent: 'Agent',
      roundsShort: '{{count}} calls',
      roleUser: 'User',
      roleAi: 'AI',
      loading: 'Loading...',
      ...
      exeApps: 'Desktop applications',
      esData: 'Data maintenance',
      esReadOnly: 'Read-only',
      esSelectKb: 'Knowledge base',
      esSelectKbPlaceholder: 'Select a knowledge base',
      esLoadingKb: 'Loading knowledge bases…',
      esPickKbHint:
        'Select a knowledge base to inspect its document-store data.',
      esEngine: 'Engine',
      esIndexName: 'Index',
      esIndexStatus: 'Index status',
      esIndexExist: 'Exists',
      esIndexMissing: 'Not created',
      esChunkTotal: 'Chunks in index',
      esDocCount: 'Documents',
      esKeyword: 'Keyword',
      esKeywordPlaceholder: 'Full-text search; leave empty to browse',
      esDocument: 'Document',
      esAllDocuments: 'All documents',
      esSearch: 'Search',
      esColDocument: 'Document',
      esColContent: 'Content',
      esColKeywords: 'Keywords',
      esColAvailable: 'Enabled',
      esYes: 'Yes',
      esNo: 'No',
      esView: 'View',
      esTotalChunks: '{{count}} chunks',
      esChunkDetail: 'Chunk detail',
      esLoadingDetail: 'Loading…',
      retrievalTest: 'Retrieval test',
      rtReadOnly: 'Read-only',
      rtSelectKb: 'Knowledge base',
      rtSelectKbPlaceholder: 'Select a knowledge base',
      rtLoadingKb: 'Loading knowledge bases…',
      rtPickKbHint:
        'Select a knowledge base, then run a query to compare retrieval before and after reranking.',
      rtQuestion: 'Query',
      rtQuestionPlaceholder:
        'Enter a query to retrieve from this knowledge base',
      rtDocument: 'Document',
      rtAllDocuments: 'All documents',
      rtRun: 'Run',
      rtRunning: 'Retrieving…',
      rtEmbeddingModel: 'Embedding model',
      rtRerankModel: 'Rerank model',
      rtRerankUnavailable: 'No rerank model available',
      rtBefore: 'Before rerank (hybrid)',
      rtAfter: 'After rerank',
      rtNoResults: 'No chunks matched.',
      rtRank: 'Rank',
      rtScore: 'Score',
      rtVector: 'Vector',
      rtTerm: 'Term',
      rtMoved: 'Rank change vs. before rerank',
      rtMovedUp: 'up {{n}}',
      rtMovedDown: 'down {{n}}',
      rtMovedNew: 'new',
      rtMovedSame: '—',
      rtTotal: '{{count}} candidates',
      rtNeedQuestion: 'Enter a query first.',
      ...
      appWebOrVersion: 'URL / version',
      appVersionSummary: '{{count}} versions · latest {{latest}}',
      appOnShelf: 'On',
      appOffShelf: 'Off',
      appExeCreateHint:
        'Save the application first, then upload installation packages via Version management.',
      appExeManageHint:
        'Upload and manage installation packages via Version management.',
      versionManagement: 'Version management',
      appVersion: 'Version',
      appVersionRequired: 'Version is required',
      appVersionNotes: 'Release notes',
      appPackage: 'Installation package',
      appPackageRequired: 'Please choose an installation package',
      appPackageTooLarge: 'The package exceeds the 1 GB limit',
      appPackageSizeHint:
        'Allowed: .exe / .msi / .zip, up to 1 GB per package.',
