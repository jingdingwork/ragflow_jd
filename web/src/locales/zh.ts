export default {
  translation: {
    ...
    header: {
      ...
      welcome: '欢迎来到',
      brand: '京鼎智能平台',
      brandTagline: '京鼎工程 · 企业级智能知识与问答平台',
      dataset: '知识库',
      memories: '记忆',
      apps: '应用',
    },
    ...
    feedback: {
      ...
      module_app: '应用',
      content: '反馈内容',
      contentPlaceholder: '描述你遇到的问题或优化建议,可直接粘贴截图',
      priority: '优先级',
    ...
    applications: {
      ...
      noDescription: '暂无描述',
      noPermission: '无权限',
      noPermissionTip: '你所在的部门未获授权，仅可查看应用名称。',
      open: '打开',
      download: '下载',
      downloading: '下载中...',
      noPackage: '暂无可用安装包',
      ...
      back: '返回',
      openNewTab: '在新标签页打开',
      embedBlocked: '该应用无法在此内嵌显示，请在新标签页中打开。',
    },
    admin: {
      loginTitle: '管理控制台',
      title: '京鼎管理控制台',
      ...
      announcementPage: {
        description: '创建并管理首页公告，支持置顶与浏览统计。',
        create: '新建公告',
        createTitle: '新建公告',
        editTitle: '编辑公告',
        currentLatest: '当前最新公告',
        title: '标题',
        titlePlaceholder: '请输入公告标题',
        content: '正文',
        contentPlaceholder: '使用 Markdown 编写正文',
        previewEmpty: '右侧为实时预览',
        markdownHint: '正文支持 Markdown 语法，右侧为实时预览。',
        pinned: '置顶',
        popEnabled: '进入首页自动弹出',
        views: '浏览量',
        viewers: '浏览人数',
        ...
        empty: '暂无公告',
        deleteTitle: '删除公告',
        deleteConfirm: '确定删除公告「{{title}}」吗？此操作不可恢复。',
      },
      systemSettings: '系统设置',
      systemSettingsPage: {
        description: '管理系统级配置。',
      ...
      searchMemberPlaceholder: '搜索昵称 / 工号 / 邮箱',
      searchMemberNoResult: '未找到匹配的员工',
      syncDepartments: '同步部门',
      syncDepartmentsResult:
        '同步完成：新增 {{created}} 个，更新 {{updated}} 个（Keycloak 共 {{total}} 个用户）',
      departmentLlmConfig: '模型配置',
      departmentLlmConfigured: '模型配置（已配置）',
      userLlmConfig: '用户模型配置',
      userLlmNoDeptToken:
        '该部门尚未配置模型令牌。请先配置部门，再为该用户启用模型。',
      ...
      employeeId: '工号',
      syncModelsResult:
        '模型已同步：新增 {{added}} 个，移除 {{removed}} 个，覆盖 {{departments}} 个部门',
      deptAdmin: '部门管理员',
      ...
      impersonateOpened: '已在新标签页以 {{name}} 的身份打开会话',
      modelApiKey: 'API 密钥',
      fetchModels: '获取模型',
      fetchModelsResult: '已获取 {{count}} 个模型',
      modelsEnabledCount: '已启用 {{enabled}} / {{total}}',
      noModelsFetched: '暂无模型——请填写 URL/密钥后获取',
      modelTypeEmbedding: '嵌入模型',
      modelTypeImage2text: '视觉模型',
      modelTypeSpeech2text: '语音识别',
      modelTypeRerank: '重排模型',
      modelTypeTts: '语音合成',
      otherModelSettings: '其他模型设置',
      modelCapWebSearch: '联网搜索',
      modelCapImageParse: '图片解析',
      modelCapMultimodal: '多模态',
      modelCapabilities: '能力类型',
      ...
      modelCustomTagsPlaceholder: '输入标签后回车',
      modelCatalogDeleteTitle: '删除模型',
      modelCatalogDeleteConfirm: '确定从模型清单中删除「{{name}}」吗？',
      globalLlmConfig: '全局模型设置',
      globalLlmDescription:
        '从同一个供应商为每种类型（嵌入、视觉、语音识别、重排、语音合成）各设置一个全局模型，将对所有用户生效，作为该类型的默认模型。',
      globalLlmSelectPlaceholder: '选择模型（可选）',
      save: '保存',
      saveSuccess: '保存成功',
      ...
      exportTypeMember: '成员',
      exportName: '名称',
      noChatData: '该范围内暂无聊天活动',
      departmentMember: '部门 / 成员',
      sessionsColumn: '会话数',
      roundsColumn: '调用数',
      chatHistoryDetailTitle: '聊天记录',
      chatSessionsCount: '{{count}} 个会话',
      noConversations: '该范围内暂无会话',
      selectConversation: '选择一个会话进行查看',
      noMessages: '暂无消息',
      sourceChat: '聊天',
      sourceAgent: '智能体',
      roundsShort: '{{count}} 次调用',
      roleUser: '用户',
      roleAi: 'AI',
      loading: '加载中...',
      ...
      promptPageHint:
        '管理用户创建聊天时使用的默认提示词和各部门提示词。部门用户在创建聊天时可自行选择;未设置时使用默认提示词。',
      newPrompt: '新建提示词',
      editPrompt: '编辑提示词',
      promptName: '名称',
      ...
      promptDepartmentRequired: '请选择部门',
      promptIsDefault: '设为默认',
      promptIsDefaultHint: '同范围内的预选项。设为默认会取消同范围其他默认项。',
      promptSystem: '系统提示词',
      promptSystemPlaceholder: '请输入系统提示词…',
      promptPrologue: '开场白',
      promptProloguePlaceholder: '用户进入聊天时显示的助手问候语…',
      promptSort: '排序',
      esData: '数据维护',
      kbManagement: '知识库管理',
      pqTitle: '文件管理',
      pqHint:
        '知识库全部文件的解析状态与排队情况;可将“未解析/排队中”的文件插队优先解析。正在解析中的文件无法抢占。',
      pqColFile: '文件',
      pqColDept: '部门',
      pqColKb: '知识库',
      pqColMethod: '解析方式',
      ...
      pqStatusUnstart: '未解析',
      pqStatusQueued: '排队中',
      pqStatusParsing: '正在解析',
      pqStatusDone: '已完成',
      pqStatusFailed: '失败',
      pqStatusCancelled: '已取消',
      pqTabActive: '待处理',
      pqPrioritize: '插队优先',
      pqPrioritizeDisabledTip: '仅“未解析/排队中”的文件可插队',
      pqPrioritized: '已插到解析队首',
      pqPrioritizeFailed: '插队失败',
      pqAllDepartments: '全部部门',
      pqAllKbs: '全部知识库',
      pqSearchPlaceholder: '搜索文件名',
      pqTotal: '共 {{count}} 个文件',
      pqParseSelected: '批量解析',
      pqParseSelectedCount: '批量解析 ({{count}})',
      pqParseSubmitted: '已提交 {{parsed}} 个文件解析，跳过 {{skipped}} 个',
      pqParseFailed: '批量解析失败',
      pqSelectRow: '选择该文件',
      pqSelectAll: '全选可解析文件',
      feedbackManagement: '意见反馈',
      fbAll: '全部',
      fbStatusOpen: '待处理',
      fbStatusInProgress: '处理中',
      fbStatusDone: '已完成',
      fbAllModules: '全部模块',
      fbAllPriorities: '全部优先级',
      fbSearchPlaceholder: '搜索反馈内容',
      fbColTime: '时间',
      fbColSubmitter: '提交人',
      fbColDept: '部门',
      fbColModules: '模块',
      ...
      fbStat_total: '全部',
      fbStat_open: '待处理',
      fbStat_in_progress: '处理中',
      fbStat_done: '已完成',
      fbDetailTitle: '反馈详情',
      fbStatus: '处理状态',
      fbNote: '处理备注',
      fbNotePlaceholder: '填写处理说明(可选)',
      fbUpdated: '已更新',
      deptFolderManagement: '文件管理',
      deptFolderPageHint:
        '将部门共享文件夹(已挂载到服务器)绑定到知识库。每天凌晨自动同步,也可随时手动增量同步或全量重建。',
      newDeptFolder: '新建文件夹绑定',
      editDeptFolder: '编辑文件夹绑定',
      deptFolderName: '名称',
      deptFolderNamePlaceholder: '留空则默认使用文件夹路径',
      deptFolderDepartment: '部门',
      deptFolderDepartmentPlaceholder: '选择部门',
      deptFolderKb: '知识库',
      deptFolderKbPlaceholder: '选择目标知识库',
      deptFolderKbRequired: '请选择知识库',
      deptFolderPath: '文件夹路径',
      deptFolderPathRequired: '请输入文件夹路径',
      deptFolderPathHint:
        '挂载到服务器/容器内的路径,例如 /mnt/dept-a。请先在宿主机挂载共享盘。',
      deptFolderTest: '检测',
      deptFolderAccessible: '文件夹可访问',
      deptFolderTestOk: '可访问 —— 发现 {{count}} 个受支持文件',
      deptFolderTestFail: '无法访问该文件夹,请检查挂载和权限。',
      deptFolderExcludeDirs: '排除目录',
      deptFolderExcludeDirsHint:
        '以逗号分隔的目录名,同步时跳过。回收站(如 #recycle)默认已排除。',
      deptFolderRefreshFreq: '刷新间隔(分钟)',
      deptFolderRefreshFreqHint: '自动同步的间隔。每天凌晨的全量检查不受影响。',
      deptFolderRecursive: '包含子文件夹',
      deptFolderRecursiveHint: '递归同步所有子目录中的文件。',
      deptFolderSyncDeleted: '同步删除',
      deptFolderSyncDeletedHint:
        '当文件从文件夹中删除时,从知识库中移除对应文档,保持数量一致。',
      deptFolderAllowImages: '包含图片',
      deptFolderAllowImagesHint: '同时同步图片文件(jpg、png 等)。',
      deptFolderSync: '同步',
      deptFolderRebuild: '重建',
      deptFolderSyncQueued: '已加入增量同步队列',
      deptFolderRebuildQueued: '已加入全量重建队列',
      deptFolderSyncState: '同步状态',
      deptFolderNeverSynced: '未同步',
      deptFolderDocCount: '{{count}} 个文档',
      syncStatusUnstart: '未开始',
      syncStatusRunning: '同步中',
      syncStatusCancel: '已取消',
      syncStatusDone: '已同步',
      syncStatusFail: '失败',
      syncStatusSchedule: '排队中',
      kbReadOnly: '只读',
      kbListTitle: '全部知识库',
      kbGroupBy: '分组方式',
      kbGroupByDept: '按部门',
      kbGroupByOwner: '按所属人',
      kbSearchPlaceholder: '搜索知识库名称…',
      kbUnassignedDept: '未分配部门',
      kbUnknownOwner: '未知所属人',
      kbColOwner: '所属人',
      kbColDept: '部门',
      kbColDocs: '文档',
      kbColChunks: '分块',
      kbColPermission: '可见范围',
      kbPermMe: '仅自己',
      kbPermTeam: '团队',
      kbPermDepartment: '部门',
      kbPermCompany: '公司级',
      ...
      esReadOnly: '只读',
      esSelectKb: '知识库',
      esSelectKbPlaceholder: '选择一个知识库',
      esLoadingKb: '正在加载知识库…',
      esPickKbHint: '选择一个知识库以查看其文档存储（ES）中的数据。',
      esEngine: '引擎',
      esIndexName: '索引',
      esIndexStatus: '索引状态',
      esIndexExist: '已存在',
      ...
      esDocCount: '文档数',
      esKeyword: '关键词',
      esKeywordPlaceholder: '全文检索；留空则浏览全部',
      esDocument: '文档',
      esAllDocuments: '全部文档',
      esSearch: '检索',
      esColDocument: '文档',
      ...
      esNo: '否',
      esView: '查看',
      esTotalChunks: '共 {{count}} 个分块',
      esChunkDetail: '分块详情',
      esLoadingDetail: '加载中…',
      retrievalTest: '检索测试',
      rtReadOnly: '只读',
      rtSelectKb: '知识库',
      rtSelectKbPlaceholder: '选择一个知识库',
      rtLoadingKb: '正在加载知识库…',
      rtPickKbHint: '选择一个知识库，然后运行查询以对比重排前后的检索效果。',
      rtQuestion: '查询',
      rtQuestionPlaceholder: '输入查询语句，在该知识库中检索',
      rtDocument: '文档',
      rtAllDocuments: '全部文档',
      rtRun: '运行',
      rtRunning: '检索中…',
      ...
      rtVectorWeight: '向量权重',
      rtVectorWeightHint:
        '向量分与关键词分的权重（0 = 仅关键词，1 = 仅向量）。',
      rtThreshold: '相似度阈值',
      rtThresholdHint: '过滤掉最终分低于此值的分块。设为 0 则展示完整排序。',
      rtTopK: 'Top K',
      rtTopKHint: '排序前从索引中召回的最大候选数。',
      rtEmbeddingModel: '向量模型',
      rtRerankModel: '重排模型',
      rtRerankUnavailable: '无可用的重排模型',
      rtBefore: '重排前（混合检索）',
      rtAfter: '重排后',
      rtNoResults: '没有匹配的分块。',
      rtRank: '排名',
      ...
      appVisibilityDept: '按部门',
      appVisibilityHint:
        '在下方选择部门。选择某个部门时，其所有子部门也会一并获得访问权限。',
      appWebOrVersion: '地址 / 版本',
      appVersionSummary: '{{count}} 个版本 · 最新 {{latest}}',
      appOnShelf: '上架',
      appOffShelf: '下架',
      appExeCreateHint: '请先保存应用，再通过“版本管理”上传安装包。',
      appExeManageHint: '通过“版本管理”上传与管理安装包。',
      versionManagement: '版本管理',
      appVersion: '版本',
      appVersionRequired: '版本号为必填项',
      appVersionNotes: '更新说明',
      appPackage: '安装包',
      appPackageRequired: '请选择安装包',
      appPackageTooLarge: '安装包超过 1 GB 限制',
      appPackageSizeHint: '支持 .exe / .msi / .zip，单个不超过 1 GB。',
      uploadVersion: '上传版本',
      noVersions: '暂无版本',
      latestVersion: '最新',
      currentVersion: '当前版本',
      ...
      sandboxSettingsPage: {
        description: '配置代码执行沙箱提供方。沙箱用于智能体中的代码组件。',
        providerSelection: '提供方选择',
        providerSelectionDescription: '为代码执行选择一个沙箱提供方',

        namedProviderConfiguration: '{{name}} 配置',
        namedProviderConfigurationDescription: '配置 {{name}} 的连接设置。',
      ...
      importFileTips: '文件必须仅包含一个名为 <code>email</code> 的表头列。',
...
例如：一条带有 1024 维嵌入的 1 KB 消息大约使用 9 KB。5 MB 的默认限制大约可容纳 500 条此类消息。`,
    ...
    knowledgeList: {
      ...
      retrieval: {
        ...
        empty: '未找到相关内容',
        emptyHint: '尝试更换关键词，或扩大知识库检索范围。',
        searching: '检索中…',
        noKnowledgeBase: '暂无可检索的知识库。',
        initial: '选择检索范围并输入关键词即可开始检索。',
        preview: '预览文档',
        download: '下载',
      },
    },
...
`,
    ...
    knowledgeConfiguration: {
      ...
      department: '部门',
      company: '公司级',
      companyTip: '公司级知识库由管理员在后台设置，全公司可见（只读）。',
      cancel: '取消',
      methodTitle: '分块方法说明',
      methodExamples: '示例',
...
NER：使用 spaCy NER 和基于规则的关键词提取来抽取实体和关系，无需 LLM 参与提取过程，速度快且资源消耗低`,
    ...
    chat: {
      ...
      share: '分享',
      shareZone: '分享区',
      shareZoneEmpty: '暂无部门内分享的会话',
      shareSelectRecords: '选择要分享的聊天记录',
      shareNoRecords: '该会话暂无可分享的记录',
      shareSuccess: '分享成功',
      pendingReview: '待审核',
      hidden: '已隐藏',
      syncToAll: '同步部门所有人',
      syncedToAll: '已同步给部门所有人',
      hide: '隐藏',
      unhide: '取消隐藏',
      continueFromShare: '点击预览，确认后复制并继续聊天',
      continueChat: '继续聊天',
      ...
      saveValidationFailed: '请先完善必填项后再保存',
      promptTemplate: '提示词',
      promptTemplatePlaceholder: '选择提示词',
      applyPromptTemplate: '选择已保存的提示词',
      savePrompt: '保存为我的提示词',
      savePromptTitle: '保存提示词',
      promptName: '提示词名称',
      promptNamePlaceholder: '为这条提示词命名，便于下次复用',
      deletePromptTitle: '删除该提示词',
      systemRequiredToSave: '系统提示词为空，无法保存',
...
示例：general/v2/`,
    ...
    fileManager: {
      shareToDepartment: '共享到部门',
      unshareFromDepartment: '取消部门共享',
